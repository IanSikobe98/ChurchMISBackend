...
import com.mis.church.config.security.JwtUtil;
...
import com.mis.church.repository.RolePrivilegeRepo;
import com.mis.church.repository.UserLoginLogRepo;
...
//            String password = commonTasks.AESdecrypt(authRequest.getPassword());
            ...
            if (authentication.isAuthenticated()) {
                ...
                if (principal instanceof SecurityUser) {
                    // If authenticated via UserDetailsService
            ...
            boolean isStaticOtp = Boolean.parseBoolean(environment.getProperty("church.app.isStaticOtp", "false"));
            log.info("is Static OTP {}",isStaticOtp);
            String otp = "";
            if(isStaticOtp){
                otp =environment.getProperty("church.app.staticOtpValue","70000");
            }
            else {
